...
DATA_BLOCK_SIZE = 512  # FFT size for equalization
...
# Delay parameters
DELAY_VALUES = [200.4]  # Fractional delay for testing
...
EARLY_LATE_KP = 0.01  # Proportional gain
EARLY_LATE_KI = 0.001  # Integral gain
